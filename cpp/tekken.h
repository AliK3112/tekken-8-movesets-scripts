...
namespace Tekken
{
  ...
  std::string NEXT_MOVE_ADDR_SIG_BYTES = "44 38 AB ?? ?? ?? ?? 0F B6 CA 41 0F 44 CD 44 38 AB ?? ?? ?? ?? 0F B6 D1 41 0F 44 D5 44 38 AB ?? ?? ?? ?? 0F B6 CA 41 0F 44 CD 44 38 AB ?? ?? ?? ?? 0F B6 D1 41 0F 44 D5 44 38 AB ?? ?? ?? ?? 0F B6 CA 41 0F 44 CD 44 38 AB ?? ?? ?? ?? 0F B6 D1 41 0F 44 D5 44 38 AB ?? ?? ?? ?? 0F B6 CA 41 0F 44 CD 44 38 AB ?? ?? ?? ?? 0F B6 D1 41 0F 44 D5 44 38 AB ?? ?? ?? ?? 0F B6 CA 41 0F 44 CD 44 38 AB ?? ?? ?? ?? 0F B6 D1 41 0F 44 D5 44 38 AB ?? ?? ?? ?? 0F B6 CA 41 0F 44 CD 44 38 AB ?? ?? ?? ?? 0F B6 D1 41 0F 44 D5 41 3A C5 0F B6 DA 41 0F 44 DD";
